...
test("Continuable Style Tests", function(T) {
    ...
    map( create, function(kind,statuses) {
        map( statuses, function(result,create) {
            ...
            create()(function(E,V){ Continue.resolve(E,V) })
                    (function(E,V) {
            ...
            create()(function(E,V){ if (V) { return V } })
                    (function(E,V) {
            ...
            if ( result == 'success' ) {
                create()(function(E,V){ return "STILL OK" })
                        (function(E,V){ T.is(V, "STILL OK", "chained w/success->new val" ) });
            }
        })
    })

    Continue(function(R){ R.withoutErrors("OK") })
